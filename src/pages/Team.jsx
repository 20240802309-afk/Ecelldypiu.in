...
const coreTeam = [
  ...
  { name: 'RIGVED AHERRAO', position: 'TECHNICAL LEAD', image: '/team/RIGVED AHEARRAO.png', icon: Users },
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-stretch border-4 border-white">
            ...
            <div className="md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-zinc-900 overflow-hidden">
              <h2 className="text-5xl md:text-6xl lg:text-8xl font-black mb-6 tracking-tighter leading-[0.9]">
